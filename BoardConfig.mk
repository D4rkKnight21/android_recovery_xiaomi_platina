...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 24293376 # This is the maximum known partition size, but it can be higher, so we just omit it
...
# SHRP Configuration
SHRP_DEVICE_CODE := platina
SHRP_PATH := device/xiaomi/$(SHRP_DEVICE_CODE)
SHRP_MAINTENER := D4rkKnight21
